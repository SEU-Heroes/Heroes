...
public class FingerGestures : MonoBehaviour
{
    ...
    public static event Gesture1.EventHandler OnGestureEvent;
    ...
    internal static void FireEvent( Gesture1 gesture )
    {
    ...
    #region Standard Global & Per-Finger Gesture1 Recognizers
