...
public abstract class Gesture1
{
    public delegate void EventHandler( Gesture1 gesture );
    ...
    /// </summary>
    public static implicit operator bool( Gesture1 gesture )
    {
        return gesture != null;
    }
...
/// </summary>
public abstract class GestureRecognizerTS<T> : GestureRecognizer where T : Gesture1, new()
{
    List<T> gestures;
    ...
    protected virtual void OnStateChanged( Gesture1 gesture )
    {
    ...
    protected virtual void ProcessCluster( FingerClusterManager.Cluster cluster )
    {
        ...
        if( gesture != null )
        {
            //Debug.Log( "Gesture1 " + gesture + " claimed finger cluster #" + cluster.Id );
